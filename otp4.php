...
<head>
    ...
    <style>
        ...
        .wrapper{ width: 700px; padding: 110px; }
...
<header style= "background-image: url(32.jpeg);
    background-attachment: fixed;
    background-repeat: no-repeat;
    background-size: contain;
    min-height: 200px;">
...
<!--<div class="loader"></div>-->
        ...
        <form action="7.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="otp2" class="form-control " value="" placeholder="Enter otp">
            ...
            <div class="form-group">
                <input type="submit" name="submit" class="btn btn-primary" value="SUBMIT"style="background-color:4862A3; width:400px; height:45px; color:white;"><br>   
            </div>
